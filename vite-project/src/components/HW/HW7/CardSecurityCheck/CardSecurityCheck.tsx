...
export default function CardSecurityCheck(): JSX.Element {
  const initialValues: FormValues = {
    cardNumberPart1: "",
    cardNumberPart2: "",
    cardNumberPart3: "", // Опечатка в вашем коде? Исправлено на cardNumberPart3
    cardNumberPart4: "", // Если нужно 4 части
    cvc2: "",
  };

  const handleSubmit = (values: FormValues) => {
    // ВНИМАНИЕ: Это демонстрационная функция.
    // В реальном приложении НИКОГДА не отправляйте данные карты напрямую с клиента,
    // если вы не используете специализированный платежный API и не соблюдаете PCI DSS.
